class Visit < ActiveRecord::Base
  attr_accessible :client_id, :day_of_week, :user_id, :invoice_id, :visit_date,
   :visit_price, :visit_type, :visit_block_id, :client_name, :end_time,
   :american_start_date, :time_text, :end_time_text, :checkin_lon, :checkin_lan,
   :checkin_date
